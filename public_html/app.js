	...
	_createClass(ItemSetWidget, [{
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(Download, { show: this.props.showDownload, id: this.state.id, data: this.state.itemset }),
